  ...
  <div id="weather_wrapper">
    <div class="weatherCard" v-for="(element,index) in weatherArr"
      ...
      <div class="currentTemp">
        ...
        <div class="points">
          <div class="point" :style="{backgroundColor:n==indexs?'#7474BF':''}" @click="clickPoint(indexs)"
               v-for="(elements,indexs) in weatherArr" :key="indexs"></div>
        </div>
      </div>
      <div class="currentWeather">
        ...
        <span class="conditions" v-else-if="element.type=='小雨'||element.type=='中雨'||element.type=='大雨'">&#xf019;</span>
        <div class="info">
